...
def analyze(generator, model, period_list = ["hour"]):
    ...
    for line in generator:
        ...
        plotable_data.append( (tb,count,model.get_result()) )
        logr.debug("{0} {1:>8} {2:.2f}".format(tb,str(count),model.get_result())) 
...
if __name__ == "__main__":
    ...
    model = models.Poisson(mode=args.mode,config={"alpha":args.alpha}) 
